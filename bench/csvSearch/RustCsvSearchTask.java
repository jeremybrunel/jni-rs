...
public class RustCsvSearchTask implements BenchmarkTask {
    ...
    private static native String findInRustCsv(String searchWord, String csvPath);
    ...
    public Object perform(Object... args) throws Exception {
        ...
        return findInRustCsv(searchWord, csvPath);
    }
}
